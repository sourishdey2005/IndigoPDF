    ...
    <footer className="bg-slate-50 border-t py-12 dark:bg-slate-900">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            <h4 className="font-semibold mb-4 text-sm uppercase tracking-wider text-slate-400">Tools</h4>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-sm uppercase tracking-wider text-slate-400">Developer</h4>
