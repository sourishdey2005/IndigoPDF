  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground text-lg">Extract table data from your PDF into Excel spreadsheets.</p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="text-center text-sm text-muted-foreground italic">
          Feature enhancement: Table recognition logic is being refined for complex layouts.
        </div>
      </div>
    </div>
  );
