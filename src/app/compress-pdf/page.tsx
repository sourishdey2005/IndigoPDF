...
import { Zap, ArrowRight, Download, Loader2, Settings2, FileText, CheckCircle2 } from "lucide-react";
...
export default function CompressPDFPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      // Small artificial delay to show progress for better UX
      ...
      toast({
        ...
        description: `Your PDF has been optimized using native browser-based re-distillation.`,
      });
    } catch (error) {
      console.error(error);
      toast({
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground text-lg">
          Reduce file size while maintaining professional quality using native re-distillation.
        </p>
      </div>
                  ...
                  <CardContent className="p-8 space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <Slider
                        ...
                        className="py-4"
                      />
                      <div className="p-4 bg-slate-50 rounded-2xl border border-dashed flex justify-between text-xs font-mono">
                        <span className="text-muted-foreground">Original:</span>
                        <span className="font-bold">{formatSize(originalSize)}</span>
                      </div>
          ...
          >
            ...
            <div className="max-w-md mx-auto grid grid-cols-2 gap-4 mb-10">
              ...
              <div className="p-4 bg-emerald-50 rounded-2xl border border-emerald-100">
                ...
                <p className="text-lg font-bold text-emerald-600">{formatSize(compressedSize)}</p>
              </div>
            </div>
