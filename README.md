...
## 🚀 Key Features
- **Organize**: Merge, Split, and Organize PDF pages with ease.
...
- **PDF Core**: `pdf-lib` & `pdf.js` (WebAssembly powered)
- **AI Integration**: Genkit (Google AI)
- **Animation**: Framer Motion

## 📦 How to Push to GitHub
If you are setting this up for the first time, run:

```bash
git init
git remote add origin https://github.com/sourishdey2005/IndigoPDF.git
git add .
git commit -m "feat: Complete PDF utility suite"
git branch -M main
...
---
*IndigoPDF - Your documents, your privacy.*
